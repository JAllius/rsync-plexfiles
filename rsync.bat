...
wsl sudo sh -c "mkdir -p /mnt/src_rsync_drive/%foldername%; mount -r -t drvfs %src_drive% /mnt/src_rsync_drive/%foldername%; mkdir -p /mnt/dst_rsync_drive; mount -t drvfs %dst_drive% /mnt/dst_rsync_drive; rsync -avh /mnt/src_rsync_drive/%foldername% /mnt/dst_rsync_drive --delete-delay --progress"
